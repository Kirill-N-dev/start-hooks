...
// Компонент текста (проп передан ниже)
...
// Функция выведения всего текста или же его части с предложением подписаться
const getTwoParagraph = (text) => {
    const arrParagraph = text.split(/\n/);
    /* console.log(arrParagraph.slice(0, 2)[1]); */
...
// Компонент с применением клонирования

const CloneElementExample = () => {
    const [isSubscribe, setIsSubscribe] = useState(false);

    // Получаем элемент
    const someText = `Классический текст Lorem Ipsum, используемый с XVI века
